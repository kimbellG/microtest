...
var File_proto_timer_timer_proto protoreflect.FileDescriptor
...
var (
	file_proto_timer_timer_proto_rawDescOnce sync.Once
	file_proto_timer_timer_proto_rawDescData = file_proto_timer_timer_proto_rawDesc
)

func file_proto_timer_timer_proto_rawDescGZIP() []byte {
	file_proto_timer_timer_proto_rawDescOnce.Do(func() {
		file_proto_timer_timer_proto_rawDescData = protoimpl.X.CompressGZIP(file_proto_timer_timer_proto_rawDescData)
	})
	return file_proto_timer_timer_proto_rawDescData
}
...
func init() { file_proto_timer_timer_proto_init() }
func file_proto_timer_timer_proto_init() {
	if File_proto_timer_timer_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_proto_timer_timer_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_proto_timer_timer_proto_goTypes,
		DependencyIndexes: file_proto_timer_timer_proto_depIdxs,
		MessageInfos:      file_proto_timer_timer_proto_msgTypes,
	}.Build()
	File_proto_timer_timer_proto = out.File
	file_proto_timer_timer_proto_rawDesc = nil
	file_proto_timer_timer_proto_goTypes = nil
	file_proto_timer_timer_proto_depIdxs = nil
}
